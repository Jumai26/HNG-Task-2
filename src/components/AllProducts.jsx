...
export default function BestSellers() {
    return (
        <div className='sm:mx-20 mb-3 mx-6 sm:m-0 font-headings font-medium'>
            <p className='sm:text-4xl sm:leading-10 mb-5 sm:mb-10'>All Products</p>
            ...
            <div className=' flex flex-row flex-wrap flex-shrink flex-grow justify-between sm:justify-between gap-x-2 gap-y-8 sm:gap-6 '>
                ...
                <div className='justify-between w-[127px] h-[132px] sm:w-[250px] sm:h-[257px] rounded-t-xl mb-20'>
            ...
            <p className='text-[9px] sm:text-base sm:leading-4 font-medium font-body sm:mb-10 text-center'>See More</p>
        </div>
    )
};
