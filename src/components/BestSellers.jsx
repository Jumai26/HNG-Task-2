...
export default function BestSellers() {
    return (
        <div className='sm:mx-20 mb-3 mx-6 sm:m-0 font-headings font-medium'>
            ...
            <div className=' flex flex-row flex-wrap flex-shrink justify-between sm:justify-between gap-x-2 gap-y-8 sm:gap-6 '>
                ...
                <div className='justify-center item-center w-[127px] h-[132px] sm:w-[250px] sm:h-[257px] rounded-t-xl'>
