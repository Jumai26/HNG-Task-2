                ...
                <div className=" grid grid-cols-2 gap-6">
                    <div className="">
                        <div className="flex flex-col justify-between content-start">
                            <p className='text-[9px] sm:text-xl leading-none sm:leading-2 font-medium sm:my-1' >Shipping Details</p>
                            <hr className="my-3"></hr>
                            <div className="flex flex-row justify-between">
                                <p className='text-[9px] sm:text-base leading-none sm:leading-2 font-bold sm:my-1'>Fullstack Mechanic </p>
                            ...
                            <p className='text-[9px] sm:text-xl leading-none sm:leading-2 font-medium sm:my-1 pt-16'>Payment Details</p>
                            <hr className="my-3"></hr>
                            <form method="post" className="container ">
                                <div className='flex flex-col justify-start pt-4'>
                                    <label id="name" for="name">Name on card</label>
                                    <input id="name" type="text" placeholder="e.g Fullstack Mechanic" className='border rounded-xl border-gray-600 h-14 my-1 placeholder:pl-3 ' required />
                                </div>
                                <div className='flex flex-col justify-start pt-6'>
                                    <label id="email" for="email"> Card Number</label>
                                    <input id="email" type="number" placeholder="e.g 123 45 678" className='border rounded-xl border-gray-600 h-14 my-1 placeholder:pl-3 ' required />
                                </div>
                                <div className='grid grid-cols-2 gap-6 pt-6'>
                                    <div className='flex flex-col justify-start '>
                                        <label id="email" for="email"> Exp. Date</label>
                                        <input id="email" type="number" placeholder="e.g 10/10/2005" className='border rounded-xl border-gray-600 h-14 my-1 placeholder:pl-3 ' required />
                                    </div>
                                    <div className='flex flex-col justify-start '>
                                        <label id="email" for="email"> CVV</label>
                                        <input id="email" type="number" placeholder="e.g 001" className='border rounded-xl border-gray-600 h-14 my-1 placeholder:pl-3 ' required />
                                    </div>
                                </div>
                                <div>
                                    <Link to="/">
