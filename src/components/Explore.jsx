...
export default function Explore() {
    return (
        <div className='sm:mx-20 my-3 mx-6 sm:mt-16 sm:mb-6 h-[575px] font-headings font-medium grid sm:grid-cols-2 stretch flex-grow gap-x-2 gap-y-8 sm:gap-6'>
            <div className=" -mb-16 sm:mb-0">
                <p className='mt-9 sm:mt-0 sm:text-5xl sm:leading-[55px] mb-5'>Explore New Collections</p>
