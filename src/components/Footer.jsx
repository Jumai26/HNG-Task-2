...
export default function Footer(params) {
    return (
        <div className='-mb-7 font-body font-normal text-[9px] sm:text-sm bg-black text-white'>
            ...
            <div  className="flex justify-center gap-4 sm:gap-10 pt-5 sm:pt-10 ">
            ...
            <div className="flex justify-center gap-x-10 py-5 sm:py-10 ">© 2024 Fullstack Mechanic. All rights reserved</div>
        </div>
    )
};
